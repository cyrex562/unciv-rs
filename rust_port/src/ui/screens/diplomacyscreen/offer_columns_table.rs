...
impl OfferColumnsTable {
    ...
    pub fn update(&mut self) {
        ...
        self.our_offers_table.update(
            ...
            &this.trade_logic.their_available_offers,
            &this.our_civ,
            &this.their_civ
        );

        this.their_offers_table.update(
            &this.trade_logic.current_trade.their_offers,
            &this.trade_logic.our_available_offers,
            &this.our_civ,
            &this.their_civ
        );

        this.their_available_offers_table.update(
