...
impl BorderedTable {
    ...
    pub fn clone(&self) -> Self {
        ...
        let bg_inner = skin_strings.get_ui_background(&self.path, &skin_strings.rectangle_with_outline_shape);
        let bg_border = skin_strings.get_ui_background(&format!("{}Border", self.path), &skin_strings.rectangle_with_outline_shape);
