...
use crate::battle::battle_damage::CombatAction;
use crate::civilization::managers::religion_manager::ReligionState;
use crate::models::ruleset::{
    Belief, RulesetStatsObject, StateForConditionals, UniqueTarget,
};
